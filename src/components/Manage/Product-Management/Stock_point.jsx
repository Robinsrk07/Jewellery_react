                 ...
                 " style={{ borderSpacing: '0 12px', borderCollapse: 'separate',minWidth:'1200px' }}>
                   ...
                   <tbody>
                       ...
                       <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                         ...
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">Jewellery stored in a central warehouse before being distributed to stores or branches..
                       ...
                       <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                         ...
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">Jewellery available at a physical store for immediate purchase.
                       ...
                       <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                         ...
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">Jewellery being transferred between the warehouse and store or between branches.
                            </td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">ACTIVE</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs" style={{ paddingLeft: '10px' }}>
                            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
