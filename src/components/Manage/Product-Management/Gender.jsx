         ...
         <table className="table w-full text-sm text-left text-gray-500" style={{ borderSpacing: '0 12px', borderCollapse: 'separate',minWidth:'1200px' }}>
           ...
           <tbody>
               ...
               <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                 <td className="px-6 py-5 border-b border-gray-200 text-xs" style={{paddingLeft:'10px'}}>1</td>
                 <td className="px-6 py-5 border-b border-gray-200 text-xs">Men's Jewellery</td>
                 <td className="px-6 py-5 border-b border-gray-200 text-xs">Includes rings, bracelets, cufflinks, chains, and kada (bangles).</td>
               ...
               <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                 <td className="px-6 py-5 border-b border-gray-200 text-xs" style={{paddingLeft:'10PX'}}>2</td>
                 <td className="px-6 py-5 border-b border-gray-200 text-xs">Women's Jewellery</td>
                 <td className="px-6 py-5 border-b border-gray-200 text-xs">Includes earrings, necklaces, bangles, nose pins, and anklets.</td>
                 <td className="px-6 py-5 border-b border-gray-200 text-xs">ACTIVE</td>
                 <td className="px-6 py-5 border-b border-gray-200 text-xs" style={{ paddingLeft: '10px' }}>
                    <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                        <button
