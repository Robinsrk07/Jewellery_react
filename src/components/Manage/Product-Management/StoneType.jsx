                 ...
                 " style={{ borderSpacing: '0 12px', borderCollapse: 'separate',minWidth:'1200px' }}>
                   ...
                   <tbody>
                       ...
                       <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                         ...
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">Ruby</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">A precious red gemstone symbolizing love and passion</td>
                       ...
                       <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                         ...
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">Sapphire</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">	A durable gemstone available in various colors, with blue being the most famous</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">ACTIVE</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs" style={{ paddingLeft: '10px' }}>
                            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                                <button
                       ...
                       <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                         <td className="px-6 py-5 border-b border-gray-200 text-xs" style={{paddingLeft:'20PX'}}>2</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">Emerald</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">A vibrant green gemstone known for its elegance and rarity</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs">ACTIVE</td>
                         <td className="px-6 py-5 border-b border-gray-200 text-xs" style={{ paddingLeft: '10px' }}>
                            <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                                <button
