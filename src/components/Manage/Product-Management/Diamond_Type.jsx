             ...
             " style={{ borderSpacing: '0 12px', borderCollapse: 'separate',minWidth:'1200px' }}>
               ...
               <tbody>
                   ...
                   <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                     ...
                     <td className="px-6 py-5 border-b border-gray-200 text-xs">Natural Diamonds</td>
                     <td className="px-6 py-5 border-b border-gray-200 text-xs">Mined from the earth, these are the most traditional and valuable diamonds.</td>
                   ...
                   <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                     ...
                     <td className="px-6 py-5 border-b border-gray-200 text-xs">Lab-Grown Diamonds</td>
                     <td className="px-6 py-5 border-b border-gray-200 text-xs">Created in a controlled environment, they have the same physical and chemical properties as natural diamonds but are more affordable.</td>
                     <td className="px-6 py-5 border-b border-gray-200 text-xs">ACTIVE</td>
                     <td className="px-6 py-5 border-b border-gray-200 text-xs" style={{ paddingLeft: '10px' }}>
                        <div style={{ display: 'flex', gap: '10px', alignItems: 'center' }}>
                            <button
