                ...
                <div className="bg-white w-full
                 ...
                 style={{ fontFamily: 'Open Sans',overflow:'auto'}}
                   >
                          ...
                          >
                              <Link to="/dashboard/inventory/diamond/createDiamondPurchase">
                        <button
                       ...
                       <table className="table w-full text-sm text-left text-gray-500 border-collapse min-w-[1500px]
                       " style={{ borderSpacing: '0 12px', borderCollapse: 'separate', }}>
                         <thead className="text-xs text-gray-400 uppercase bg-white">
                           <tr>
                             ...
                             <th className="px-6 py-3   "  >STOCK POINT</th>
                             <th className="px-6 py-3  " >NO OF PIECES</th>
                             <th className="px-6 py-3 "  >DESCRIPTION</th>
                             <th className="px-6 py-3 "  >MARK UP</th>
                             <th className="px-6 py-3 "  >  TAX</th>
                             <th className="px-6 py-3 "  >  BUYER</th>
                             <th className="px-6 py-3 "  >ID LENGTH</th>
                         ...
                         <tbody>
                             ...
                             <tr  className="bg-white hover:bg-gray-50 h-[44px] text-gray-400">
                               ...
                               <td className="px-6 py-5 border-b border-gray-200 text-xs">DESCRIPTION</td>
                               <td className="px-6 py-5 border-b border-gray-200 text-xs">MARKUP</td>
                               <td className="px-6 py-5 border-b border-gray-200 text-xs">2%</td>
